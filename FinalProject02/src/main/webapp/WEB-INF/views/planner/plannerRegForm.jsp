...
<body>
 <%@ include file="/WEB-INF/views/include/header.jsp" %>
	...
	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#regDailyModal">
	bootstrap modal
</button>
	...
	제목<input type="text" name="ptitle" value="${ptitle}">
		...
		<form id="serialize">
			<c:forEach items="${dateList}" var="list">
					...
					<a href="#regDailyModal" rel="modal:open" class="${list}" onclick="searchReset(); showItemEl(); searchPlaces(); writeddate(this);" >+</a>
